...
###               one typo (year date) changed November 7, 2019             ###
###############################################################################
#
...
#
# Note that simulating one network wave is straightforward,
# using an algorithm object with
# useStdInits=FALSE, cond=FALSE, nsub=0, simOnly=TRUE;
# this is further not elaborated here.
#
# The script implements one particular model specification
...
# as in Tom A.B. Snijders and Christian E.G. Steglich (2015),
