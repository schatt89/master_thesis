...
myCoEvolutionEff <- includeEffects(myCoEvolutionEff, gwespBB, gwespFF,
...
SimulateNetworksBehavior <- function(net.w1, b1.w1, n, c1,
                                     rate, dens, rec, gwespbb, gwespff, inPopSq,
                                     outActSq,
  ...
  InitEff0 <- setEffect(InitEff0, gwespBB, initialValue = gwespbb)
  InitEff0 <- setEffect(InitEff0, gwespFF, initialValue = gwespff)
...
dens = ans60$theta[2]
rec = ans60$theta[3]
gwespbb = ans60$theta[4]
gwespff = ans60$theta[5]
inPopSq = ans60$theta[6]
outActSq = ans60$theta[7]
altX.b1 = ans60$theta[8] 
egoX.b1 = ans60$theta[9] + 1
egoXaltX.b1 = ans60$theta[10] + 1
rate.b1 = ans60$theta[11]
lin.b1 = ans60$theta[12]
qu.b1 = ans60$theta[13]
avalt.b1 = ans60$theta[14]
